...
export function About() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-14">
      ...
      />
      <p className="text-xs font-semibold uppercase tracking-wider text-[#67e8f9] mb-3">À propos</p>
      <h1 className="text-4xl font-extrabold tracking-tight mb-6">
        Rendre l'accessibilité web simple et mesurable
      </h1>
      <div className="space-y-5 text-[#cbd5e1] leading-relaxed text-lg">
        <p>
        ...
        <p>
          Konforme est édité par <strong className="text-[#f1f5fb]">KAYZEN SASU</strong>, société
          ...
          inclus, dont la <Link to="/accessibilite" className="text-[#67e8f9] hover:underline">déclaration
          d'accessibilité</Link> est publique.
        </p>
      </div>

      <h2 className="text-2xl font-bold tracking-tight mt-12 mb-4">Nos engagements</h2>
      <ul className="space-y-3 text-[#cbd5e1] leading-relaxed list-disc pl-5">
        <li><strong className="text-[#f1f5fb]">Transparence</strong> : un audit automatisé ne couvre pas tout, et nous le disons. Nous affichons ce qui est testé et ce qui relève d'un audit manuel.</li>
        <li><strong className="text-[#f1f5fb]">Pédagogie</strong> : chaque non-conformité est expliquée avec sa correction, pour faire monter vos équipes en compétence.</li>
        <li><strong className="text-[#f1f5fb]">Données en Europe</strong> : vos données sont hébergées dans l'Union européenne (Appwrite Cloud, région Francfort), sur une infrastructure open source.</li>
      </ul>
