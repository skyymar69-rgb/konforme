  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-14">
      <Seo
        ...
        path="/accessibilite"
      />
      <p className="text-xs font-semibold uppercase tracking-wider text-[#67e8f9] mb-3">Accessibilité</p>
      ...
      <div className="space-y-4 text-[#cbd5e1] leading-relaxed">
        <p>
          <strong className="text-[#f1f5fb]">KAYZEN SASU</strong> s'engage à rendre son site
        ...
        <p>
          ...
          <strong className="text-[#f1f5fb]">konforme.kayzen-lyon.fr</strong>.
        </p>
      </div>
      ...
      <p className="text-[#cbd5e1] leading-relaxed mb-4">
        Le site konforme.kayzen-lyon.fr est <strong className="text-[#f1f5fb]">partiellement
      ...
      <p className="text-[#cbd5e1] leading-relaxed mb-4">
        ...
        <a href="mailto:contact@kayzen-lyon.fr" className="text-[#67e8f9] hover:underline">
      ...
      <ul className="space-y-2 text-[#cbd5e1] leading-relaxed list-disc pl-5">
        <li>
          Écrire au{' '}
          <a href="https://formulaire.defenseurdesdroits.fr/" className="text-[#67e8f9] hover:underline" rel="noopener noreferrer" target="_blank">
            Défenseur des droits<span className="sr-only"> (nouvelle fenêtre)</span>
          </a>
        </li>
        <li>
          Contacter{' '}
          <a href="https://www.defenseurdesdroits.fr/saisir/delegues" className="text-[#67e8f9] hover:underline" rel="noopener noreferrer" target="_blank">
